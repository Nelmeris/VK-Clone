...
// Выполнение запроса
public func VKRequest<Response: VKBaseModel>(sender: UIViewController, version: VKAPIVersions = .v5_74, method: VKAPIMethods, parameters: [String : String] = ["" : ""], completion: @escaping(Response) -> Void = {_ in}) {
